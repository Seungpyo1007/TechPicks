...
**P0 · P1.5 · P2.1 · P2.2 · P2.4 를 오늘 끝냈다.** 외부 입력 없이 할 수 있는
것은 이제 남아 있지 않다.

다음에 움직이려면 둘 중 하나가 필요하다.

- **콘솔 작업** → P1 (출시 요건). 이게 되면 스토어에 낼 수 있다
- **제품 결정** → P3.1 공유 문구, P3.2 카탈로그 전달 방식

P3.4(골든 테스트)만 예외로 지금도 가능하다. 다만 유리 크롬이 골든에서
안정적인지부터 확인해야 해서 결과를 장담 못 한다.
