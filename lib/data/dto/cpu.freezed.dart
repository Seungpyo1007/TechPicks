...
mixin _$Cpu {
 ...
 String get slug; String get name; int? get id; Brand? get manufacturer; String? get releaseDate;/// `desktop` / `laptop` / `server` 등.
 String? get segment; String? get architecture; String? get socket;/// 공정. CPU는 `TSMC N4` 같은 문자열이라 SoC의 `processNm`과 타입이 다르다.
 String? get processNode; int? get cores; int? get threads;/// 하이브리드 구조에서만 채워진다.
 int? get pCores; int? get eCores; double? get baseClockGhz; double? get boostClockGhz; double? get l3CacheMb; int? get tdpW; int? get maxTdpW; String? get integratedGraphics; String? get memorySupport; int? get msrpUsd; CpuScore? get score; bool get verified; List<String> get sourceUrls; String? get url;
/// Create a copy of Cpu
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CpuCopyWith<Cpu> get copyWith => _$CpuCopyWithImpl<Cpu>(this as Cpu, _$identity);
...
@useResult
$Res call({
 String slug, String name, int? id, Brand? manufacturer, String? releaseDate, String? segment, String? architecture, String? socket, String? processNode, int? cores, int? threads, int? pCores, int? eCores, double? baseClockGhz, double? boostClockGhz, double? l3CacheMb, int? tdpW, int? maxTdpW, String? integratedGraphics, String? memorySupport, int? msrpUsd, CpuScore? score, bool verified, List<String> sourceUrls, String? url
});


$BrandCopyWith<$Res>? get manufacturer;$CpuScoreCopyWith<$Res>? get score;

}
/// @nodoc
class _$CpuCopyWithImpl<$Res>
    implements $CpuCopyWith<$Res> {
...
as int?,pCores: freezed == pCores ? _self.pCores : pCores // ignore: cast_nullable_to_non_nullable
...
as int?,maxTdpW: freezed == maxTdpW ? _self.maxTdpW : maxTdpW // ignore: cast_nullable_to_non_nullable
as int?,integratedGraphics: freezed == integratedGraphics ? _self.integratedGraphics : integratedGraphics // ignore: cast_nullable_to_non_nullable
...
as CpuScore?,verified: null == verified ? _self.verified : verified // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Cpu value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Cpu value)  $default,){
final _that = this;
switch (_that) {
case _Cpu():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Cpu value)?  $default,){
final _that = this;
switch (_that) {
case _Cpu() when $default != null:
return $default(_that);case _:
...
@override final  String? processNode;
@override final  int? cores;
@override final  int? threads;
/// 하이브리드 구조에서만 채워진다.
@override final  int? pCores;
@override final  int? eCores;
@override final  double? baseClockGhz;
@override final  double? boostClockGhz;
@override final  double? l3CacheMb;
@override final  int? tdpW;
@override final  int? maxTdpW;
@override final  String? integratedGraphics;
@override final  String? memorySupport;
@override final  int? msrpUsd;
@override final  CpuScore? score;
...
@pragma('vm:prefer-inline')
_$CpuCopyWith<_Cpu> get copyWith => __$CpuCopyWithImpl<_Cpu>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$CpuToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Cpu&&(identical(other.slug, slug) || other.slug == slug)&&(identical(other.name, name) || other.name == name)&&(identical(other.id, id) || other.id == id)&&(identical(other.manufacturer, manufacturer) || other.manufacturer == manufacturer)&&(identical(other.releaseDate, releaseDate) || other.releaseDate == releaseDate)&&(identical(other.segment, segment) || other.segment == segment)&&(identical(other.architecture, architecture) || other.architecture == architecture)&&(identical(other.socket, socket) || other.socket == socket)&&(identical(other.processNode, processNode) || other.processNode == processNode)&&(identical(other.cores, cores) || other.cores == cores)&&(identical(other.threads, threads) || other.threads == threads)&&(identical(other.pCores, pCores) || other.pCores == pCores)&&(identical(other.eCores, eCores) || other.eCores == eCores)&&(identical(other.baseClockGhz, baseClockGhz) || other.baseClockGhz == baseClockGhz)&&(identical(other.boostClockGhz, boostClockGhz) || other.boostClockGhz == boostClockGhz)&&(identical(other.l3CacheMb, l3CacheMb) || other.l3CacheMb == l3CacheMb)&&(identical(other.tdpW, tdpW) || other.tdpW == tdpW)&&(identical(other.maxTdpW, maxTdpW) || other.maxTdpW == maxTdpW)&&(identical(other.integratedGraphics, integratedGraphics) || other.integratedGraphics == integratedGraphics)&&(identical(other.memorySupport, memorySupport) || other.memorySupport == memorySupport)&&(identical(other.msrpUsd, msrpUsd) || other.msrpUsd == msrpUsd)&&(identical(other.score, score) || other.score == score)&&(identical(other.verified, verified) || other.verified == verified)&&const DeepCollectionEquality().equals(other._sourceUrls, _sourceUrls)&&(identical(other.url, url) || other.url == url));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,slug,name,id,manufacturer,releaseDate,segment,architecture,socket,processNode,cores,threads,pCores,eCores,baseClockGhz,boostClockGhz,l3CacheMb,tdpW,maxTdpW,integratedGraphics,memorySupport,msrpUsd,score,verified,const DeepCollectionEquality().hash(_sourceUrls),url]);
...
abstract mixin class _$CpuCopyWith<$Res> implements $CpuCopyWith<$Res> {
  factory _$CpuCopyWith(_Cpu value, $Res Function(_Cpu) _then) = __$CpuCopyWithImpl;
@override @useResult
$Res call({
 String slug, String name, int? id, Brand? manufacturer, String? releaseDate, String? segment, String? architecture, String? socket, String? processNode, int? cores, int? threads, int? pCores, int? eCores, double? baseClockGhz, double? boostClockGhz, double? l3CacheMb, int? tdpW, int? maxTdpW, String? integratedGraphics, String? memorySupport, int? msrpUsd, CpuScore? score, bool verified, List<String> sourceUrls, String? url
});
...
@override $BrandCopyWith<$Res>? get manufacturer;@override $CpuScoreCopyWith<$Res>? get score;

}
/// @nodoc
class __$CpuCopyWithImpl<$Res>
