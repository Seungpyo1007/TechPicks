...
@useResult
$Res call({
 String slug, String name, int? id, Brand? manufacturer, String? architecture, String? releaseDate, int? msrpUsd, int? cudaCores, int? streamProcessors, int? rtCores, int? tensorCores, double? memoryGb, String? memoryType, int? memoryBusBit, double? memoryBandwidthGbps, int? baseClockMhz, int? boostClockMhz, int? tdpW, String? pcieVersion, double? fp32Tflops, double? blenderScore, GpuScore? score, bool verified, List<String> sourceUrls, String? url
});


$BrandCopyWith<$Res>? get manufacturer;$GpuScoreCopyWith<$Res>? get score;

}
/// @nodoc
class _$GpuCopyWithImpl<$Res>
    implements $GpuCopyWith<$Res> {
...
as int?,cudaCores: freezed == cudaCores ? _self.cudaCores : cudaCores // ignore: cast_nullable_to_non_nullable
...
as double?,memoryType: freezed == memoryType ? _self.memoryType : memoryType // ignore: cast_nullable_to_non_nullable
as String?,memoryBusBit: freezed == memoryBusBit ? _self.memoryBusBit : memoryBusBit // ignore: cast_nullable_to_non_nullable
...
as double?,baseClockMhz: freezed == baseClockMhz ? _self.baseClockMhz : baseClockMhz // ignore: cast_nullable_to_non_nullable
as int?,boostClockMhz: freezed == boostClockMhz ? _self.boostClockMhz : boostClockMhz // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Gpu value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Gpu value)  $default,){
final _that = this;
switch (_that) {
case _Gpu():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Gpu value)?  $default,){
final _that = this;
switch (_that) {
case _Gpu() when $default != null:
return $default(_that);case _:
...
class _Gpu implements Gpu {
  const _Gpu({required this.slug, required this.name, this.id, this.manufacturer, this.architecture, this.releaseDate, this.msrpUsd, this.cudaCores, this.streamProcessors, this.rtCores, this.tensorCores, this.memoryGb, this.memoryType, this.memoryBusBit, this.memoryBandwidthGbps, this.baseClockMhz, this.boostClockMhz, this.tdpW, this.pcieVersion, this.fp32Tflops, this.blenderScore, this.score, this.verified = false, final  List<String> sourceUrls = const <String>[], this.url}): _sourceUrls = sourceUrls;
...
@override final  int? cudaCores;
@override final  int? streamProcessors;
@override final  int? rtCores;
@override final  int? tensorCores;
@override final  double? memoryGb;
@override final  String? memoryType;
@override final  int? memoryBusBit;
@override final  double? memoryBandwidthGbps;
@override final  int? baseClockMhz;
@override final  int? boostClockMhz;
@override final  int? tdpW;
@override final  String? pcieVersion;
@override final  double? fp32Tflops;
@override final  double? blenderScore;
@override final  GpuScore? score;
...
@pragma('vm:prefer-inline')
_$GpuCopyWith<_Gpu> get copyWith => __$GpuCopyWithImpl<_Gpu>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$GpuToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Gpu&&(identical(other.slug, slug) || other.slug == slug)&&(identical(other.name, name) || other.name == name)&&(identical(other.id, id) || other.id == id)&&(identical(other.manufacturer, manufacturer) || other.manufacturer == manufacturer)&&(identical(other.architecture, architecture) || other.architecture == architecture)&&(identical(other.releaseDate, releaseDate) || other.releaseDate == releaseDate)&&(identical(other.msrpUsd, msrpUsd) || other.msrpUsd == msrpUsd)&&(identical(other.cudaCores, cudaCores) || other.cudaCores == cudaCores)&&(identical(other.streamProcessors, streamProcessors) || other.streamProcessors == streamProcessors)&&(identical(other.rtCores, rtCores) || other.rtCores == rtCores)&&(identical(other.tensorCores, tensorCores) || other.tensorCores == tensorCores)&&(identical(other.memoryGb, memoryGb) || other.memoryGb == memoryGb)&&(identical(other.memoryType, memoryType) || other.memoryType == memoryType)&&(identical(other.memoryBusBit, memoryBusBit) || other.memoryBusBit == memoryBusBit)&&(identical(other.memoryBandwidthGbps, memoryBandwidthGbps) || other.memoryBandwidthGbps == memoryBandwidthGbps)&&(identical(other.baseClockMhz, baseClockMhz) || other.baseClockMhz == baseClockMhz)&&(identical(other.boostClockMhz, boostClockMhz) || other.boostClockMhz == boostClockMhz)&&(identical(other.tdpW, tdpW) || other.tdpW == tdpW)&&(identical(other.pcieVersion, pcieVersion) || other.pcieVersion == pcieVersion)&&(identical(other.fp32Tflops, fp32Tflops) || other.fp32Tflops == fp32Tflops)&&(identical(other.blenderScore, blenderScore) || other.blenderScore == blenderScore)&&(identical(other.score, score) || other.score == score)&&(identical(other.verified, verified) || other.verified == verified)&&const DeepCollectionEquality().equals(other._sourceUrls, _sourceUrls)&&(identical(other.url, url) || other.url == url));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,slug,name,id,manufacturer,architecture,releaseDate,msrpUsd,cudaCores,streamProcessors,rtCores,tensorCores,memoryGb,memoryType,memoryBusBit,memoryBandwidthGbps,baseClockMhz,boostClockMhz,tdpW,pcieVersion,fp32Tflops,blenderScore,score,verified,const DeepCollectionEquality().hash(_sourceUrls),url]);
...
abstract mixin class _$GpuCopyWith<$Res> implements $GpuCopyWith<$Res> {
  factory _$GpuCopyWith(_Gpu value, $Res Function(_Gpu) _then) = __$GpuCopyWithImpl;
@override @useResult
$Res call({
 String slug, String name, int? id, Brand? manufacturer, String? architecture, String? releaseDate, int? msrpUsd, int? cudaCores, int? streamProcessors, int? rtCores, int? tensorCores, double? memoryGb, String? memoryType, int? memoryBusBit, double? memoryBandwidthGbps, int? baseClockMhz, int? boostClockMhz, int? tdpW, String? pcieVersion, double? fp32Tflops, double? blenderScore, GpuScore? score, bool verified, List<String> sourceUrls, String? url
});
...
@override $BrandCopyWith<$Res>? get manufacturer;@override $GpuScoreCopyWith<$Res>? get score;

}
/// @nodoc
class __$GpuCopyWithImpl<$Res>
...
/// Create a copy of Gpu
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? slug = null,Object? name = null,Object? id = freezed,Object? manufacturer = freezed,Object? architecture = freezed,Object? releaseDate = freezed,Object? msrpUsd = freezed,Object? cudaCores = freezed,Object? streamProcessors = freezed,Object? rtCores = freezed,Object? tensorCores = freezed,Object? memoryGb = freezed,Object? memoryType = freezed,Object? memoryBusBit = freezed,Object? memoryBandwidthGbps = freezed,Object? baseClockMhz = freezed,Object? boostClockMhz = freezed,Object? tdpW = freezed,Object? pcieVersion = freezed,Object? fp32Tflops = freezed,Object? blenderScore = freezed,Object? score = freezed,Object? verified = null,Object? sourceUrls = null,Object? url = freezed,}) {
  return _then(_Gpu(
slug: null == slug ? _self.slug : slug // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
