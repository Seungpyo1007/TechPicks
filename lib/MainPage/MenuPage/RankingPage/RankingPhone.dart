...
class RankingPhoneScreen extends StatefulWidget {
  const RankingPhoneScreen({Key? key}) : super(key: key);

  @override
  _RankingCPUScreenState createState() => _RankingCPUScreenState();
}

class _RankingCPUScreenState extends State<RankingPhoneScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Ranking Phone'),
