...
/// Optional label typography customization for segmented control items.
struct LiquidGlassSegmentedControlConfig {
  struct LabelStyle {
    ...
    func resolvedFont(defaultSize: CGFloat = 12.0) -> UIFont? {
